...
require_once( INCLUDE_DIR . "twitteroauth/OAuth.php" );
...
//		$this->sha1_method = new OAuthSignatureMethod_PLAINTEXT();
//		$this->sha1_method = new OAuthSignatureMethod_RSA_SHA1();
